...
The Redmine Bulk Users plugin was developed to provide a way to manage multiple users to multiple projects with multiple roles.  Currently it is only allowed to be set by a Redmine Admin, as it is in the Administration section of Redmine.
